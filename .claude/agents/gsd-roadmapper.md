...
Reference full template: `/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/templates/state.md`.
