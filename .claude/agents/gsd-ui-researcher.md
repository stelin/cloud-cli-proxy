...
Use template from `/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
