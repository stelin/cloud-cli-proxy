...
<execution_context>
@/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/workflows/execute-phase.md end-to-end.
