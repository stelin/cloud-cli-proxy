...
- Usage: Reference from command with `@/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /workspace/Desktop/cloud-cli-proxy/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /workspace/Desktop/cloud-cli-proxy/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
