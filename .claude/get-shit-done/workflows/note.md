...
- **Global scope**: `/workspace/Desktop/cloud-cli-proxy/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/workspace/Desktop/cloud-cli-proxy/.claude/notes/`)
...
2. Glob `/workspace/Desktop/cloud-cli-proxy/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/workspace/Desktop/cloud-cli-proxy/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/workspace/Desktop/cloud-cli-proxy/.claude/notes/` — works in any directory
