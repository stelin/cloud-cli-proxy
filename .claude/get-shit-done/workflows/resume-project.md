...
<required_reading>
@/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/workspace/Desktop/cloud-cli-proxy/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
