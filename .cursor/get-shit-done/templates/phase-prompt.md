...
<!-- For checkpoint task examples and patterns, see @/Users/zaneliu/Projects/open-source/cloud-cli-proxy/.cursor/get-shit-done/references/checkpoints.md -->
...
See `/Users/zaneliu/Projects/open-source/cloud-cli-proxy/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/zaneliu/Projects/open-source/cloud-cli-proxy/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/zaneliu/Projects/open-source/cloud-cli-proxy/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
