...
```bash
AUDITOR_MODEL=$(node "/Users/zaneliu/Projects/open-source/cloud-cli-proxy/.cursor/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/zaneliu/Projects/open-source/cloud-cli-proxy/.cursor/agents/gsd-eval-auditor.md for instructions.
